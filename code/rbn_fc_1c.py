...
graphfile='RBN_WAL_count_v7_'+sTime.strftime('%Y')+'_'+contest+'_'+sTime.strftime('%H%M - ')+'-'+eTime.strftime('%H%M UT')
graphfile1='RBN_WAL_'+sTime.strftime('%Y')+'_'+contest+'_'+sTime.strftime('%H%M - ')+'-'+eTime.strftime('%H%M UT')+'_v7.png'
graphfile2='RBN_WAL_freq_division_'+sTime.strftime('%Y')+'_'+contest+'_'+sTime.strftime('%H%M - ')+'-'+eTime.strftime('%H%M UT')+'_v7.png'
