#!/usr/bin/env python
#This code is intended to map contacts on 80m during the ePOP pass download the RBN data from the ePOP Satellite pass on Field Day 2015
...
rbn_lib.rbn_map_plot(df_epop,legend=False,ax=ax0,tick_font_size=9,ncdxf=True,llcrnrlat=0,llcrnrlon=-135,urcrnrlon=45)
filename='ePOP_RBN_80m_zoom.jpg'
