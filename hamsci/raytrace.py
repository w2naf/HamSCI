...
def plot_iono_path_profile(tx_lat,tx_lon,ranges,heights,
    ...
    # Plot Receiver ################################################################ 
    if kwargs.has_key('rx_lat') and kwargs.has_key('rx_lon'):
...
def plot_power_path(rt_dct,ax,ylim=(-175,-100)):
    ...
    for param in plot_list:
        ...
        yy      = rd[param].tolist()
        if rt_dct.has_key('srch_ray_data'):
    ...
    if rt_dct.has_key('rx_lat') and rt_dct.has_key('rx_lon'):
