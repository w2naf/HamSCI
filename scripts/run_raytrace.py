...
#    interval_time           = datetime.timedelta(hours=1)
    ...
    event_fname             = phlp.get_event_fname(sTime,eTime,freq,tx_call,rx_call)
    ...
    run_lst                 = phlp.gen_run_list(sTime,eTime,interval_time,**run_dct)
    ...
    if multiproc:
        ...
        for this_dct in run_lst:
            rt_dct  = phlp.run_ray_trace(this_dct)
